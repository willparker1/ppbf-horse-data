...
public enum ExecutionReportErrorCode {
	ERROR_IN_MATCHER("The matcher's not healthy. Please note: The error will also be returned is you attempt concurrent 'cancel all' bets requests using cancelOrders which isn't permitted."),
